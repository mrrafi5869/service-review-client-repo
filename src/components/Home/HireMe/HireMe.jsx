...
const HireMe = () => {
    return (
        <section className="flex flex-col lg:flex-row w-9/12 mx-auto my-20" id='about'>
        ...
        <div className="lg:mx-14 mt-16 lg:mt-0">
            ...
            <h1 className="text-xl md:text-5xl font-serif my-5 text-gray-400">Adding the memories of  every moment</h1>
